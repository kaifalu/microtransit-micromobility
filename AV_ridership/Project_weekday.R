...
metropolis_hastings_lognorm = function(x, mu, sigma, n_points) {
  ...
  S = diag(2)
  for (i in 2:n_points) {
    proposed = mvrnorm(1,current,S) #2.4^2*S/2
  ...
  sampler = list(mu=mu_sigma[,1], sigma = mu_sigma[,2]^2, log_posterior=lupost, acceptance=nn/n_points,
...
layout(F_m1)
plot(1:n, model_sampler$mu, xlab="Iter", ylab=expression(mu), main="Monday: RWMH")
plot(1:n, model_sampler$sigma, xlab="Iter", ylab=expression(sigma^2), main="Monday: RWMH")
...
F_m1 <- matrix(c(1,2),nrow=1,ncol=2,byrow=TRUE)
layout(F_m1)
plot(1:n, model_sampler$mu, xlab="Iter", ylab=expression(mu), main="Tuesday: RWMH")
plot(1:n, model_sampler$sigma, xlab="Iter", ylab=expression(sigma^2), main="Tuesday: RWMH")
...
F_m1 <- matrix(c(1,2),nrow=1,ncol=2,byrow=TRUE)
layout(F_m1)
plot(1:n, model_sampler$mu, xlab="Iter", ylab=expression(mu), main="Wednesday: RWMH")
plot(1:n, model_sampler$sigma, xlab="Iter", ylab=expression(sigma^2), main="Wednesday: RWMH")
...
F_m1 <- matrix(c(1,2),nrow=1,ncol=2,byrow=TRUE)
layout(F_m1)
plot(1:n, model_sampler$mu, xlab="Iter", ylab=expression(mu), main="Thursday: RWMH")
plot(1:n, model_sampler$sigma, xlab="Iter", ylab=expression(sigma^2), main="Thursday: RWMH")
